package com.example.zyf.bsclient.ovelayutil;
                ...
                if (step.getEntrance() != null) {
                    overlayOptionses.add((new MarkerOptions())
                            ...
                            .icon(BitmapDescriptorFactory
                                    .fromResource(R.drawable.line_node)));
                }
                // 最后路段绘制出口点
...
//            }
            ...
            PolylineOptions option = new PolylineOptions().points(points).textureIndex(traffics)
                    .width(21).dottedLine(isDotLine).focus(true)
                    .color(getLineColor() != 0 ? getLineColor() : Color.argb(255, 48, 132, 255)).zIndex(-1);
            if (isDotLine) {
